...
export default function(j) {
  ...
  return {
    ...
    bodyEN: [
      ...
      { type: "h2", text: "12. Temporary layoff" },
      { type: "p", text: `You expressly agree that the Company may place you on temporary layoff in accordance with the ${j.shortEN}. A temporary layoff that complies with the ${j.shortEN} does not constitute a termination of your employment. If a layoff exceeds the duration or conditions permitted by the ${j.shortEN}, it may be deemed a termination of employment, at which point you will receive the notice (or pay in lieu) and any applicable severance set out in Section 11 of this offer. **This clause is included because, under Canadian common law, an employer has no inherent right to temporarily lay off employees without an express contractual provision; without it, even a short layoff could amount to a constructive dismissal.**` },

      { type: "h2", text: "13. Conditions of this offer" },
      ...
      { type: "h2", text: "14. Governing law and entire agreement" },
    ...
    bodyFR: [
      ...
      { type: "h2", text: "12. Mise à pied temporaire" },
      { type: "p", text: `Vous acceptez expressément que la Société puisse vous mettre à pied temporairement conformément au ${j.shortFR}. Une mise à pied temporaire conforme au ${j.shortFR} ne constitue pas une cessation de votre emploi. Si une mise à pied dépasse la durée ou les conditions permises par le ${j.shortFR}, elle peut être réputée une cessation d'emploi, auquel cas vous recevrez le préavis (ou l'indemnité compensatrice) et toute indemnité de départ applicable prévus à la Section 11 de la présente offre. **Cette clause est incluse parce que, selon la common law canadienne, un employeur n'a pas de droit inhérent de mettre temporairement à pied ses employés sans une disposition contractuelle expresse; sans cette clause, même une courte mise à pied pourrait constituer un congédiement déguisé.**` },

      { type: "h2", text: "13. Conditions de l'offre" },
      ...
      { type: "h2", text: "14. Loi applicable et accord intégral" },
      ...
      { type: "h2", text: "15. Comment accepter" },
