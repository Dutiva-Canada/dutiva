...
function Dutiva() {
  ...
  useEffect(() => {
    (async () => {
      ...
      const policyPath = { '/terms': 'terms', '/privacy': 'privacy', '/accessibility': 'accessibility', '/ai-technology': 'technology', '/disclaimer': 'terms' }[window.location.pathname];
      if (session) {
        ...
        nav(policyPath || "dashboard");
      } else {
        nav(policyPath || "welcome");
      }
    })();
    ...
    const unsub = onAuthChange((session) => {
      if (!session) {
        setUser(null);
        const onPolicyPage = ['/terms','/privacy','/accessibility','/ai-technology','/disclaimer'].includes(window.location.pathname);
        if (!onPolicyPage) nav("welcome");
      }
    });
    return unsub;
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/ai-technology" element={<AITechPage />} />
